...
import { Mic, Square, AlertCircle, X, Loader2, Volume2, User, Sparkles } from "lucide-react";
        ...
        <div className="relative w-full h-screen bg-black overflow-hidden flex flex-col">
            ...
            <div className="relative z-10 flex items-center justify-between px-6 py-4">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-white font-semibold text-lg tracking-tight">VIMA</span>
                </div>
                ...
                >
                    ...
                    {isRecording && (
                        <>
                            ...
                            <span className="absolute -inset-4 rounded-full border border-red-500/10 animate-pulse" style={{ animationDelay: "0.3s" }} />
                        </>
                    )}
